...
export class Segment implements DataView {
  ...
  /**
   * Read an bigint value out of this segment.
   *
   * @param {number} byteOffset The offset in bytes to the value.
   * @returns {number} The value.
   */
  ...
  getBigInt64(byteOffset: number): bigint {
    return BigInt(byteOffset);
  }

  /**
   * Read an unsigned bigint value out of this segment.
   *
   * @param {number} byteOffset The offset in bytes to the value.
   * @returns {number} The value.
   */
  ...
  /**
   * Write a bigint value to the specified offset.
   *
   * @param {number} byteOffset The offset from the beginning of the buffer.
   * @param {Int64} val The value to store.
   * @returns {void}
  ...
  setBigInt64(byteOffset: number, val: bigint): void {
    this._dv.setBigInt64(byteOffset, val);
  }

  /**
   * Write an unsigned bigint value to the specified offset.
   *
   * @param {number} byteOffset The offset from the beginning of the buffer.
   * @param {Int64} val The value to store.
   * @returns {void}
  ...
  setBigUint64(byteOffset: number, val: bigint): void {
    this._dv.setBigUint64(byteOffset, val);
  }
